...
export const PHASE_THEMES = {
  ...
  luteal: {
    key: 'luteal',
    gradient: 'from-[#D4C4E4] via-[#B8A4CC] to-[#8E7AA8]',
    meshA: 'rgba(212,196,228,0.45)',
    meshB: 'rgba(142,122,168,0.35)',
    meshC: 'rgba(245,240,252,0.25)',
    glow: 'rgba(142,122,168,0.45)',
...
export const CATEGORY_GRADIENTS = {
  ...
  pregnancy_test: 'from-violet-200/80 to-violet-400/60',
